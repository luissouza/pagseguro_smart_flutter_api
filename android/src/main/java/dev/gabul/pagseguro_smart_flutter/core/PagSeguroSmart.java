    ...
    public void initPayment(MethodCall call, MethodChannel.Result result) {
        ...
        if(call.method.equals(PAYMENT_DEBIT)){
           this.payment.doDebitPayment(call.argument("value"));
            ...
            this.nfcPayment.writeNFCCard(call.argument("idCaixa"), call.argument("idCarga"), call.argument("nome"), call.argument("cpf"), call.argument("numeroTag"), call.argument("valorProdutos"), call.argument("saldoAtual"));
        }
        else{
